...
Version  : 3.1.2
Release  : 38
URL      : https://github.com/htop-dev/htop/archive/3.1.2/htop-3.1.2.tar.gz
Source0  : https://github.com/htop-dev/htop/archive/3.1.2/htop-3.1.2.tar.gz
...
%prep
%setup -q -n htop-3.1.2
cd %{_builddir}/htop-3.1.2
%patch1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1638529584
...
cp %{_builddir}/htop-3.1.2/COPYING %{buildroot}/usr/share/package-licenses/htop/4cc77b90af91e615a64ae04893fdffa7939db84c
%make_install

...
Source0  : https://github.com/htop-dev/htop/archive/3.1.1/htop-3.1.1.tar.gz
...
%prep
%setup -q -n htop-3.1.1
cd %{_builddir}/htop-3.1.1
%patch1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1634254077
...
cp %{_builddir}/htop-3.1.1/COPYING %{buildroot}/usr/share/package-licenses/htop/4cc77b90af91e615a64ae04893fdffa7939db84c
%make_install

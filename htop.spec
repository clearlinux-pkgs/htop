...
Version  : 3.2.0
Release  : 39
URL      : https://github.com/htop-dev/htop/archive/3.2.0/htop-3.2.0.tar.gz
Source0  : https://github.com/htop-dev/htop/archive/3.2.0/htop-3.2.0.tar.gz
...
%prep
%setup -q -n htop-3.2.0
cd %{_builddir}/htop-3.2.0
%patch1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1651600085
...
cp %{_builddir}/htop-3.2.0/COPYING %{buildroot}/usr/share/package-licenses/htop/4cc77b90af91e615a64ae04893fdffa7939db84c
%make_install

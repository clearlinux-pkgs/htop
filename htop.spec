...
Source0  : https://github.com/htop-dev/htop/archive/3.0.0/htop-3.0.0.tar.gz
...
%prep
%setup -q -n htop-3.0.0
cd %{_builddir}/htop-3.0.0
%patch1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1599024803
...
cp %{_builddir}/htop-3.0.0/COPYING %{buildroot}/usr/share/package-licenses/htop/044462b5c756fee77f267e633f57ce4acfa778e4
%make_install

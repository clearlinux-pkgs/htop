...
Version  : 3.0.4
Release  : 34
URL      : https://github.com/htop-dev/htop/archive/3.0.4/htop-3.0.4.tar.gz
Source0  : https://github.com/htop-dev/htop/archive/3.0.4/htop-3.0.4.tar.gz
...
%prep
%setup -q -n htop-3.0.4
cd %{_builddir}/htop-3.0.4
%patch1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1609291902
...
cp %{_builddir}/htop-3.0.4/COPYING %{buildroot}/usr/share/package-licenses/htop/044462b5c756fee77f267e633f57ce4acfa778e4
%make_install
